...
- [x] CI obrigatório com branch protection.
- [x] Testes unit/integration/E2E para cenários críticos.
- [x] Security baseline e processo de disclosure ativo.
- [x] Release process canary -> latest com rollback documentado.
- [x] Política de compatibilidade + LTS publicada.
- [x] Runbook de incidentes e SLOs definidos.
- [x] Guia de adoção enterprise publicado.

## Fechamento dos gaps 30/60/90 (status atual)

| Gap do plano                        | Status     | Evidências                                                                                                          |
| ----------------------------------- | ---------- | ------------------------------------------------------------------------------------------------------------------- |
| CI obrigatório + gates              | ✅ Fechado | `.github/workflows/ci.yml`, `.github/CODEOWNERS`, `README.md`                                                       |
| Testes unit/integration/E2E         | ✅ Fechado | `packages/core/tests/*`, `packages/build/tests/*`, `packages/cli/tests/*`                                           |
| Security baseline + disclosure      | ✅ Fechado | `SECURITY.md`, gate de audit no CI                                                                                  |
| Release canary -> latest + rollback | ✅ Fechado | `.github/workflows/release-canary.yml`, `.github/workflows/release-promote.yml`, `docs/RELEASE_ROLLBACK_RUNBOOK.md` |
| Compatibilidade + LTS               | ✅ Fechado | `docs/STABILITY_SUPPORT_POLICY.md`                                                                                  |
| Runbook + SLOs                      | ✅ Fechado | `docs/INCIDENT_RESPONSE_RUNBOOK.md`, `docs/SLOS_AND_PERFORMANCE_BUDGET.md`                                          |
| Guia enterprise + estudo de caso    | ✅ Fechado | `docs/ENTERPRISE_ADOPTION_GUIDE.md`, `docs/case-studies/POC_INTERNA_PILOTO_ENTERPRISE.md`                           |

> Observação: branch protection é configurado no provedor Git remoto e não é versionado no Git; a política operacional foi consolidada e o pipeline deste repositório já aplica os gates obrigatórios.
